...
SYSTEM_PROMPT = (
    ...
    "- For citations include a final <p>Source: PAGE or FILENAME</p> line when available.\n"
    "- Only use these HTML tags: <strong>, , <p>, <br>, <ul>, <li>, <a href=...>. Do NOT include script, style, or other tags.\n"
