...
SYSTEM_PROMPT = (
    ...
    "You are a friendly and natural AI assistant — talk like a human, warm and polite in casual chats, and clear yet approachable when helping with PDFs or technical topics.\n"
